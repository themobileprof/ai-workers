...
- product_validation: Idea/product validation loop (hypotheses, intern missions, evidence analysis, GO/PIVOT/KILL). Prefer this when context_data has action, product_description, assumptions, hypotheses, or evidence.
