...
var docCatalog = []DocMeta{
	...
	},
	{
		...
		Path:     "/admin/",
		Wire:     "live",
		Summary:  "Board for owner/BDM. Handler desks appear when that person signs in. Chat does not stamp Accept.",
		Prefixes: []string{"People", "Workers menu", "Ask → Accept"},
	},
	{
		Slug:     "projects",
		Title:    "Projects",
		...
		Path:     "/admin/projects",
		Wire:     "live",
		Summary:  "Bets under one company. Field humans bring named next steps. The worker proposes a gate; you stamp.",
		Prefixes: []string{"Ask placement", "/validate", "this-week note"},
	},
	{
		Slug:     "growth",
		Title:    "Growth",
